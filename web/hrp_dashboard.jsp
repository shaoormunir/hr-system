        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="home.html" target="_parent"> <i class="glyphicon glyphicon-home"></i> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation">
                                <a href="home.html"> <i class="glyphicon glyphicon-home"></i> Home</a>
                            </li>
                            <li role="presentation"><a href="about.jsp"><i class="glyphicon glyphicon-cog"></i> About </a></li>
                            <li role="presentation"><a href="Contact.html"><i class="glyphicon glyphicon-earphone"></i> Contact Us</a></li>
                            <li role="presentation">
                                <a href="Services.html"> <i class="glyphicon glyphicon-object-align-bottom"></i> Services</a>
                            </li>
                        </ul>
                    </li>
                    <li role="presentation">
                        <a href="applicant_dashboard.jsp"> <i class="fa fa-list-alt"></i> Dashboard</a>
                    </li>
                    <li role="presentation">
                        <a href="Jobs.html"> <i class="fa fa-list-alt"></i> Jobs</a>
                    </li>
                    <li role="presentation"><a href="Profile.html"><i class="glyphicon glyphicon-user"></i> <% out.print(request.getSession().getAttribute("name")); %></a></li>
                </ul>
                <form class="navbar-form navbar-left" target="_self">
                    <div class="form-group">
                        <label class="control-label" for="search-field"><i class="glyphicon glyphicon-search"></i></label>
                        <input class="form-control search-field" type="search" name="search" placeholder="Search TitanicTech" id="search-field">
                    </div>
                </form><a class="btn btn-default navbar-btn navbar-right action-button" role="button" href="index.html"><i class="glyphicon glyphicon-off"></i> Log Out</a></div>
        </div>
    </nav>
</div>
<fieldset>
            ...
            <div class="col-md-12">
                <div>
                    <ul class="nav nav-tabs nav-justified">
                        <li><a href="#tab-1" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-blackboard"></i> Jobs Advertisement</a></li>
                        <li class="active"><a href="#tab-2" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-list-alt"></i> Receiving CVs</a></li>
                        <li><a href="#tab-3" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-calendar"></i> Interview 1</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane" role="tabpanel" id="tab-1">
                            ...
                            <div class="dynamic-table">
                                    ...
                                    <div class="col-md-12 column">
                                        <table class="table table-bordered table-hover dynamic-table-tab_logic">
                                            ...
                                            <tr class='dynamic-table-addr0' style='display:none;'>
                                                <td>
                                                    <input type="image" name='pic0'  placeholder='Picture' class="form-control"/>
                                                </td>
                                                <td>
                                                    <select type="text" name='tit0' placeholder='Please Select' class="form-control">
                                                        <option value='i'>IT Expert</option>
                                                        <option value='a'>Android Developer</option>
                                                        <option value='s'>Software Engineer</option>
                                                        <option value='w'>Web Designer</option>
                                                        <option value='d'>Web Developer</option>
                                                        <option value='g'>Graphic Designer</option>
                                                        <option value='v'>Data Scientist</option>
                                                        <option value='b'>Database Analyst</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" name='qua0' placeholder='Qualification' class="form-control"/>
                                                </td>
                                                <td>
                                                    <input type="text" name='exp0' placeholder='Experience' class="form-control"/>
                                                </td>
                                                <td>
                                                    <input type="text" name='sea0' placeholder='Seats' class="form-control"/>
                                                </td>
                                                <td>
                                                    <input type="text" name='des0' placeholder='Description' class="form-control"/>
                                                </td>
                                                <td>
                                                    <input type="text" name='dea0' placeholder='Deadline' class="datetimepicker form-control"/>
                                                </td>
                                ...
                                <a class="dynamic-table-add_row btn btn-default pull-left">Post Jost</a><a class='dynamic-table-edit_row pull-right btn btn-default'>Edit Job</a>
                            </div>
                            </p>
                        </div>
                            ...
                            <div class="col-md-offset-1 col-xs-12 one-column-row news-bulletin-tabs">
                                <div class="ministry-tabs">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li id="tab-2016" class="news-bulletin-tabs"><a href="#current-2016" role="tab" data-toggle="tab">Job2(Software Eng.) </a></li>
                                        <li id="tab-2016" class="news-bulletin-tabs"><a href="#current-2016" role="tab" data-toggle="tab">Job3(Graphic Desig.) </a></li>
                                        <li id="tab-2016" class="news-bulletin-tabs"><a href="#current-2016" role="tab" data-toggle="tab">Job4(Android Developer)</a></li>
                                    </ul>
                                    <div class="tab-content">
                                ...
                                <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="subject" name="subject" class="form-control" required="required">
                                                                    ...
                                                                    <option value="service">Timeslot for interview</option>
                                        ...
                                        <div class="col-md-4">
                                            <form>
                                                <legend><span class="glyphicon glyphicon-globe"></span> Our Office</legend><address><strong>TitanicTechSolutions, Inc.</strong><br /><br />JT Lahore<br /><abbr title="Phone">+</abbr>(92) 555-123456</address><address><br /><a href="mailto:#">support@titanictech.com</a></address></form>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="subject" name="subject" class="form-control" required="required">
                                                                    <option value="na" selected="">Choose One:</option>
                                                                    <option value="service">Call for Interview1</option>
                                                                    <option value="suggestions">Ineligible! Sorry, you can't join us</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            <form>
                                                <legend><span class="glyphicon glyphicon-globe"></span> Our Office</legend><address><strong>TitanicTech, Inc.</strong><br /><br />JT Lahore<br /><abbr title="Phone">+</abbr>(92) 555-123456</address><address><br /><a href="mailto:#">support@titanictech.com</a></address></form>
                                        </div>
                                    </div>
                                </div>
                                <div class="jumbotron-contact jumbotron-contact-sm">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm-12 col-lg-12">
                                                <h1 class="h1">
                                                    View Ratings of Selected Applicants </h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-collapse collapse in item-1" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel-group" role="tablist" aria-multiselectable="true" id="accordion-3">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading" role="tab">
                                                        <h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion-3" aria-expanded="true" href="#accordion-3 .item-1">Employee 1</a></h4></div>
                                                    <div class="panel-collapse collapse in item-1" role="tabpanel">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading" role="tab">
                                                        <h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion-3" aria-expanded="false" href="#accordion-3 .item-2">Employee 2</a></h4></div>
                                                    <div class="panel-collapse collapse item-2" role="tabpanel">
                                                        <div class="panel-body"><span>Item body.</span></div>
                                                    </div>
                                                </div>
                                                <div class="panel panel-default">
                                                    <div class="panel-heading" role="tab">
                                                        <h4 class="panel-title"><a role="button" data-toggle="collapse" data-parent="#accordion-3" aria-expanded="false" href="#accordion-3 .item-3">Employee 3</a></h4></div>
