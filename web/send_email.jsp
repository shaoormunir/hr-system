        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <i class="glyphicon glyphicon-home"></i> <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation">
                                <a href="home.html"> <i class="glyphicon glyphicon-home"></i> Home</a>
                            </li>
                            <li role="presentation"><a href="About.html"><i class="glyphicon glyphicon-cog"></i> About </a></li>
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#"><i class="glyphicon glyphicon-dashboard"></i> My Dashboard <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                ...
                </form><a class="btn btn-default navbar-btn navbar-right action-button" role="button" href="index.html">Log Out</a></div>
        </div>
    </nav>
</div>
<h1 class="text-center text-info"><strong>My Profile</strong></h1>
<div>
    <ul class="nav nav-tabs nav-justified">
        <li class="active">
            <a href="#tab-1" role="tab" data-toggle="tab"> <i class="glyphicon glyphicon-user"></i> Bio</a>
        </li>
        <li><a href="#tab-2" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-blackboard"></i> Education and Social Profiles</a></li>
    </ul>
...
<footer>
    <div class="row">
        <div class="col-md-4 col-sm-6 footer-navigation">
            ...
            <p class="links"><a href="home.html">Home</a><strong> · </strong><a href="Jobs.html">Jobs </a><strong> · </strong><a href="Services.html">Services </a><strong> · </strong><a href="Contact.html">Contact</a></p>
