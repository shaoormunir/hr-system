                ...
                <div class="col-md-12">
                    <div>
                        <ul class="nav nav-tabs nav-justified">
                            <li><a href="#tab-2" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-list-alt"></i> Favourite Jobs</a></li>
                            <li class="active"><a href="#tab-1" role="tab" data-toggle="tab"><i class="glyphicon glyphicon-blackboard"></i> Jobs Status</a></li>
                        </ul>
